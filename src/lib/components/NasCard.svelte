...
<div class="bg-surface-900/70 border border-surface-800 rounded-2xl p-6 shadow-xl backdrop-blur-sm flex flex-col justify-between">
	...
	<div>
		...
		<!-- Candidate Hosts list if configured -->
		{#if status.candidateHosts && status.candidateHosts.length > 1}
			<div class="mt-3 px-3 py-2 bg-surface-950/40 border border-surface-850 rounded-xl flex items-center justify-between text-[11px] text-surface-400 font-mono">
				<span class="text-surface-500">Available routes:</span>
				<div class="flex items-center gap-2">
